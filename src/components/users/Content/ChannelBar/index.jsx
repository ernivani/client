        ...
        <SideBar>
            ...
            <Panel>
                <PanelContainer>
                    <PanelAvatar>
                        <IconAvatar>
                            <img src={`https://api.dicebear.com/5.x/personas/svg?seed=${token}`} alt="avatar" />
                        </IconAvatar>
                        <NameTag>
                            <UsernameDiv>
                    ...
                    <PanelButtons style={{flex: '0 1 auto'}}>
                        <AddButton>
                            <ButtonIconDiv>
                                <ButtonIcon width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    <path d="M21 4.27L19.73 3L3 19.73L4.27 21L8.46 16.82L9.69 15.58L11.35 13.92L14.99 10.28L21 4.27Z" fill='rgb(247, 63, 67)'></path>
                                </ButtonIcon>
                            </ButtonIconDiv>
                        </AddButton>
                        <AddButton>
